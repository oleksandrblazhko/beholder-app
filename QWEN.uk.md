...
- Angle - кут повороту маркера, наприклад, експерименти показали, що у горизональному положенні маркера, кут = -45,
а його повертання навраво змуншує значення кута;
